...
combo_t key_combos[] = {
  ...
  [CM_FUNC] = COMBO(function_combo,     ADJ_LYR)
};

#if defined(ENCODER_MAP_ENABLE)
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_BASE] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_GAMING] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_COLEMAK_DH] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_GAMENUM] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_HEX] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_NAVIGATION] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_NUMPAD] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_SYMBOL] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_VIM] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_FUNCTION] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_APPSWITCH] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) },
    [_ADJUST] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LGUI_T(KC_MINS), LGUI_T(KC_EQL)) }
};
#endif
...
[_BASE] = LAYOUT(
  ...
  MEH_XCS, NUM_Z,  VIM_X,   KC_C,    KC_V,    KC_B,    KC_MUTE,                         KC_MUTE,   KC_N,    KC_M,    KC_COMM, VIM_DOT, SYM_QUE, MEH_BSL,
                   MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_GAMING] = LAYOUT(
  ...
  MEH_XCS, _______, _______, _______, _______, _______,    KC_MUTE,                         KC_MUTE,   _______, _______, _______, _______, _______, _______,
                   MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
                                                        CLIL_THM,   LOL_THM,     LOR_THM, KC_SPACE
                                                    //  NAV/TAB  LSHFT/ENTER  RSHFT/ENTER     SPACE
),
...
[_GAMENUM] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  MEH_RET, _______, _______, _______, _______, _______,    KC_MUTE,                         KC_MUTE,   _______, _______, _______, _______, _______, _______,
                   MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_COLEMAK_DH] = LAYOUT(
  ...
  XCASE,   _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,    KC_MUTE,                         KC_MUTE,   _______, _______, _______, _______, _______, _______,
                   MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_NAVIGATION] = LAYOUT(
    ...
    _______, TAB_DWN, TAB_UP,  TD_COPY, TD_PAST, _______,    KC_MUTE,                         KC_MUTE,   KC_HOME, _______, _______, KC_END,  _______, _______,
                   MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_NUMPAD] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,    KC_MUTE,                         KC_MUTE,   KC_EQL,  KC_1,    KC_2,    KC_3,    KC_SLSH, _______,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_SYMBOL] = LAYOUT(
  ...
  _______, KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, M_ARROW,    KC_MUTE,                         KC_MUTE,   KC_EQL,  KC_EXLM, KC_AT,   KC_HASH, _______, _______,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_VIM] = LAYOUT(
  ...
  _______, _______, _______, _______, SEC19,   SEC3,    KC_MUTE,                         KC_MUTE,   SEC12,   SEC2,    _______, _______, _______, _______,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
                                                        KC_BSPC, _______,         _______, _______
),
...
[_HEX] = LAYOUT(
  ...
  _______, _______, TGHEX,   _______, _______, _______,    KC_MUTE,                         KC_MUTE,   KC_EQL,  KC_1,    KC_2,    KC_3,    KC_SLSH, _______,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
                                                        _______, _______,           _______, KC_0
),
...
[_FUNCTION] = LAYOUT( \
  ...
  _______, ADJ_LYR, _______, DB_TOGG, QK_BOOT, _______,                                             RM_PREV, RM_HUED, RM_SATD, RM_VALD, RM_SPDD, _______,
  _______, MT_STTD, MT_DTTD, MT_MTTD, MT_GTTD, MT_SGTD,    KC_MUTE,                         KC_MUTE,   MT_SGTI, MT_GTTI, MT_MTTI, MT_DTTI, MT_STTI, TT_CHEK,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
...
[_APPSWITCH] = LAYOUT(
  ...
  _______, _______, MC_SWRI, _______, _______, _______,    KC_MUTE,                         KC_MUTE,   KC_N,    KC_M,    _______, _______, _______, _______,
        MON_L,   MON_R,                                                                                   KC_LBRC, KC_RBRC,
