...
[_GAMING] = LAYOUT(
  ...
  SFT_ESC, _______, KC_X,    _______, _______, _______,                                             _______, _______, _______, KC_DOT,  _______, SFT_BSL,
                                                       LIL_THM,  CLOL_THM,          CLOR_THM,  _______
                                                    // NAV/BSP   NUM/ENTER        VIM/ENTER SYM/SPACE
),
...
[_GAMENUM] = LAYOUT(
  ...
  MEH_ESC, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, MEH_QUO,
  VIM_XCS, _______, KC_X,    _______, _______, _______,                                             _______, _______, _______, KC_DOT,  _______, VIM_BSL,
                                                       LIL_THM,  LOL_THM,          LOR_THM,  _______
                                                    // NAV/BSP   SFT/ENTER        SFT/ENTER SYM/SPACE
),
...
[_SYMBOL] = LAYOUT(
  ...
  QK_LLCK, KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, M_ARROW,                                             KC_EQL,  KC_EXLM, KC_AT,   KC_HASH, _______, _______,
