...
[_GAMING] = LAYOUT(
  ...
  MEH_LDR, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, MEH_LDR,
...
[_GAMENUM] = LAYOUT(
  ...
  KC_GRV,  _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  KC_TAB,  _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  MEH_XCS, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, MEH_BSL,
                                                       _______,  _______,         _______,  _______
                                                    // NAV/BSPC  NUM/ENTER         ENTER   SYM/SPACE
),
...
[_NAVIGATION] = LAYOUT(
    ...
    KC_BSPC, CTL_BAK, ALT_FWD, SFT_TUP, GUI_TDN, _______,                                           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XCASE,   KC_MUTE,
    QK_LLCK, UNDO,    _______, TD_COPY, TD_PAST, _______,                                           KC_END,  KC_PGDN, KC_PGUP, KC_HOME, _______, _______,
...
[_SYMBOL] = LAYOUT(
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                                               KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  _______, KC_GRV,  KC_PIPE, KC_LCBR, KC_RCBR, TIPS,                                                _______, KC_AMPR, KC_ASTR, KC_LPRN, _______, _______,
  XCASE,   KC_AT,   KC_BSLS, KC_LPRN, KC_RPRN, HTTPS,                                               KC_MINS, KC_DLR,  KC_PERC, KC_CIRC, KC_COLN, KC_DQUO,
  QK_LLCK, KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, M_ARROW,                                             KC_EQL,  KC_EXLM, KC_AT,   KC_HASH, _______, SM_ANON,
                                                        KC_SPC, _______,         _______, _______
),

[_VIM] = LAYOUT(
  SM_OPUL, SEC20,   _______, _______, SEC18,   SEC5,                                                DM_REC1, DM_PLY1, DM_REC2, DM_PLY2, _______, _______,
  ...
  _______, _______, M_EXIT,  _______, SEC19,   SEC3,                                                SEC12,   SEC2,    _______, _______, _______, _______,
                                                        KC_SPACE, KC_ENTER,        _______, LEADER
),
...
[_APPSWITCH] = LAYOUT(
  ...
  _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,                                             CAD,     KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______,
