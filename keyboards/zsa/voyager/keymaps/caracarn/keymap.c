...
[_GAMING] = LAYOUT(
  ...
  SFT_ESC, _______, _______, _______, _______, _______,                                             _______, _______, _______, KC_DOT,  _______, SFT_BSL,
...
[_GAMENUM] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  MEH_TAB, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, MEH_QUO,
  HYP_ESC, SFT_Z,   _______, _______, _______, _______,                                             _______, _______, _______, KC_DOT,  SFT_QUE, HYP_BSL,
                                                       LIL_THM,  CLOL_THM,          CLOR_THM,  _______
                                                    // NAV/BSP   NUM/ENTER        VIM/ENTER SYM/SPACE
),
