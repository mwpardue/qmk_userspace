...
[_GAMING] = LAYOUT(
  ...
  MEH_RET, NUM_Z,   _______, _______, _______, _______,                                             _______, _______, _______, _______, KC_SLSH, _______,
                                                       GLIL_THM,  CLOL_THM,       CLOR_THM,  _______
                                                    // NAV/BSC    SFT/ESC        SFT/ENTER  SYM/SPACE
),
...
[_GAMENUM] = LAYOUT(
  ...
  MEH_ESC, NUM_Z,   _______, _______, _______, _______,                                             _______, _______, _______, _______, KC_SLSH, _______,
...
[_NUMPAD] = LAYOUT(
  ...
  _______, OSMLCTL, OSMLALT, OSMLSFT, OSMLGUI, HTTPS,                                               KC_MINS, KC_4,    KC_5,    KC_6,    KC_DOT,  KC_SCLN,
