...
const uint16_t PROGMEM function_combo[]     = {SM_GRV,      KC_1,                         COMBO_END};
const uint16_t PROGMEM boot_combo[]         = {SM_GRV,      KC_EQL,                       COMBO_END};
...
[_BASE] = LAYOUT(
  ...
  MEH_RET, SFT_Z,  VIM_X,   KC_C,    KC_V,    KC_B,                                                KC_N,    KC_M,    KC_COMM, VIM_DOT, SFT_QUE, MEH_BSL,
                                                    ...
                                                    // NAV/BSPC  NUM/SM_ESC          ENTER  SYM/SPACE
),
...
[_GAMING] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  _______, LSM_A,   _______, LSM_D,   _______, _______,                                             _______, _______, RSM_K,   _______, RSM_SCN, _______,
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
...
[_GAMENUM] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
  SM_ESC,  LSM_A,   _______, LSM_D,   _______, _______,                                             _______, _______, RSM_K,   _______, RSM_SCN, _______,
  _______, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, _______,
                                                       _______,  GLOL_THM,        _______,  _______
                                                    // NAV/BSPC  NUM/TAB         HYP/ENTER SYM/SPACE
),
...
[_SYMBOL] = LAYOUT(
  ...
  _______, KC_AT,   KC_BSLS, KC_LPRN, KC_RPRN, HTTPS,                                               KC_MINS, KC_DLR,  KC_PERC, KC_CIRC, KC_COLN, KC_DQUO,
