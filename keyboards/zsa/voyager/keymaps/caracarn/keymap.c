...
[_GAMING] = LAYOUT(
  ...
  APP_ESC, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, KC_QUOT,
...
[_GAMENUM] = LAYOUT(
  ...
  MEH_XCS, _______, _______, _______, _______, _______,                                             _______, _______, _______, _______, _______, MEH_BSL,
                                                       LIL_THM,  GLOL_THM,         SLOR_THM,  _______
                                                    // NAV/BSPC   NUM/ESC         VIM/ENTER SYM/SPACE
),
...
[_SYMBOL] = LAYOUT(
  ...
  QK_LLCK, KC_LT,   KC_GT,   KC_LBRC, KC_RBRC, M_ARROW,                                             KC_EQL,  KC_EXLM, KC_AT,   KC_HASH, _______, SM_BRK,
