...
[_GAMING] = LAYOUT(
  ...
  VIM_ESC, _______, KC_X,    _______, _______, _______,                                             _______, _______, _______, KC_DOT,  _______, VIM_BSL,
...
[_GAMENUM] = LAYOUT(
  ...
  VIM_TAB, _______, KC_X,    _______, _______, _______,                                             _______, _______, _______, KC_DOT,  _______, VIM_BSL,
                                                       LIL_THM,  LOL_THM,          LOR_THM,  _______
                                                    // NAV/BSP   SFT/ENTER        SFT/ENTER SYM/SPACE
),
...
[_SYMBOL] = LAYOUT(
  ...
  _______, KC_AT,   KC_BSLS, KC_LPRN, KC_RPRN, KC_PIPE,                                             KC_MINS, KC_DLR,  KC_PERC, KC_CIRC, KC_COLN, KC_DQUO,
