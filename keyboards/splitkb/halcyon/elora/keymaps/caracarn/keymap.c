...
combo_t key_combos[] = {
  ...
  const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
      ...
      [_COLEMAK_DH] = { NOENC, NOENC, NOENC, ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
      [_GAMENUM] =    { NOENC, NOENC, NOENC, ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
...
[_BASE] = LAYOUT_elora_hlc(
  ...
  MEH_XCS,  NUM_Z,    VIM_X,    KC_C,     KC_V,     KC_B,     UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  KC_N,     KC_M,     KC_COMM,  VIM_DOT,  SYM_QUE,  MEH_BSL,
...
[_GAMING] = LAYOUT_elora_hlc(
  ...
  MEH_XCS,  _______,  _______,  _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  _______,  _______,  _______,  _______,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
...
[_GAMENUM] = LAYOUT_elora_hlc(
  ...
  XCASE,    _______,  _______,  _______,  _______,  _______,                                                    _______,  _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,                                                    _______,  _______,  _______,  _______,  _______,  _______,
  MEH_RET,  _______,  _______,  _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  _______,  _______,  _______,  _______,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, SLOL_THM,           LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
...
[_COLEMAK_DH] = LAYOUT_elora_hlc(
  ...
  XCASE,    _______,  _______,  _______,  _______,  _______,                                                    _______,  _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,                                                    _______,  _______,  _______,  _______,  _______,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  _______,  _______,  _______,  _______,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
...
[_NAVIGATION] = LAYOUT_elora_hlc(
  ...
  _______,  TAB_DWN,  TAB_UP,   TD_COPY,  TD_PAST,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,   KC_HOME, _______,  _______,  KC_END,   _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_NUMPAD] = LAYOUT_elora_hlc(
  ...
  _______,  _______,  _______,  _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  KC_EQL,   KC_1,     KC_2,     KC_3,     KC_SLSH,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  KC_0,     RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_SYMBOL] = LAYOUT_elora_hlc(
  ...
  _______,  KC_LT,    KC_GT,    KC_LBRC,  KC_RBRC,  M_ARROW,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  KC_EQL,   KC_EXLM,  KC_AT,    KC_HASH,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_VIM] = LAYOUT_elora_hlc(
  ...
  _______,  _______,  _______,  _______,  SEC19,    SEC3,     UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  SEC12,    SEC2,     _______,  _______,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_HEX] = LAYOUT_elora_hlc(
  ...
  _______,  _______,  TGHEX,    _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  KC_EQL,   KC_1,     KC_2,     KC_3,     KC_SLSH,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_FUNCTION] = LAYOUT_elora_hlc( \
  ...
  _______,  MT_STTD,  MT_DTTD,  MT_MTTD,  MT_GTTD,  MT_SGTD,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  MT_SGTI,  MT_GTTI,  MT_MTTI,  MT_DTTI,  MT_STTI,  TT_CHEK,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
...
[_APPSWITCH] = LAYOUT_elora_hlc(
  ...
  _______,  _______,  MC_SWRI,  _______,  _______,  _______,  UIL_THM,  UOL_THM,            UOR_THM,  UIR_THM,  KC_N,     KC_M,     _______,  _______,  _______,  _______,
                                LUTHUM0,  LUTHUM1,  LUTHUM2,  CLIL_THM, LOL_THM,            LOR_THM,  LIR_THM,  RUTHUM2,  RUTHUM1,  RUTHUM0,
            KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO,                                                                KC_MUTE,  KC_NO,    KC_NO,    KC_NO,    KC_NO
),
